...
def generate_centered_dataset():
    ...
    print("Generating Centered Dataset...")
    ...
    for i in tqdm(range(TOTAL_IMAGES)):
        try:
            ...
            # 5. Smart Resize (Fit within 50-80% of bed)
            # This prevents the "Image too big" error
            scale = random.uniform(0.5, 0.8)
            
            # Calculate scaling factor based on the largest dimension
            # to ensure it fits inside the square
            ...
            # 9. Save Label (Center is always 0.5, 0.5 because we centered it!)
            # But we calculate it dynamically just in case size varies slightly
